...
/**
 * Created by gonen on 20/02/15.
 */
public class RecommendedScheduleDialogFragement extends DialogFragment {

    public interface NoticeDialogListener {
        public void onRecommendedDialogPositiveClick(DialogFragment dialog);
        public void onRecommendedDialogNegativeClick(DialogFragment dialog);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setPositiveButton("Apply", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                mListener.onRecommendedDialogPositiveClick(RecommendedScheduleDialogFragement.this);

            }
        });
        builder.setCancelable(true);
        builder.setTitle("Set Recommended Schedule");
